...
category: '插件'
tags: ['vitepress']
detail: '该插件用于增强 VitePress 的代码块功能。可以自动填充代码块缺少的产品图标。'
---

# VitePress 代码块图标插件

[vitepress-plugin-group-icons](https://vp.yuy1n.io/) 插件用于增强 VitePress 的代码块功能。可以自动填充代码块缺少的产品图标。
...
如果你还想为[代码段](https://vitepress.dev/zh/guide/markdown#import-code-snippets)添加标题栏：
...
```ts{2-6,17-25} [.vitepress/config.ts]
import { defineConfig } from 'vitepress'
import {
  groupIconMdPlugin,
  groupIconVitePlugin,
